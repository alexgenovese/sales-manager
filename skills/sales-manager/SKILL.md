...
This is the flagship command. It executes **5 key analysis phases** natively to analyze a prospect:

1. **Company Research** → Firmographics, growth signals, tech stack
2. **Contact Intelligence** → Decision maker identification, org mapping, personalization anchors
3. **Opportunity Assessment** → Lead qualification, pain points, budget signals, buying timeline
4. **Competitive Analysis** → Current solutions, switching costs, competitive positioning
5. **Outreach Strategy** → Outreach strategy, messaging, channel recommendation, objection prep
